...
line_to_junction.drive_until_junction(motor_left,motor_right,left2,left1,right1,right2,90,1)
line_to_junction.junction_turn(motor_left,motor_right,left2,left1,right1,right2,0)
line_to_junction.drive_until_junction(motor_left,motor_right,left2,left1,right1,right2,90,6)
line_to_junction.junction_turn(motor_left,motor_right,left2,left1,right1,right2,0)
line_to_junction.drive_until_junction(motor_left,motor_right,left2,left1,right1,right2,90,1)
line_to_junction.junction_turn(motor_left,motor_right,left2,left1,right1,right2,0)
line_to_junction.drive_until_junction(motor_left,motor_right,left2,left1,right1,right2,90,6)
...
time.sleep(1.4)
line_to_junction.drive_until_junction(motor_left,motor_right,left2,left1,right1,right2,80,0)
motor_left.off()
motor_right.off()
print("main.py Done!")